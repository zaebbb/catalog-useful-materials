...
export const CreateNotePatternService =
  createAsyncThunk<ServicePatternResponse, void, ThunkConfig<string>>(
    'CreateNote/CreateNotePatternService',
    async (
      _,
      thunkApi
    ) => {
      ...
      const formData: ServicePatternRequest = {
        linkService: state.createNotePatternService?.values.linkService ?? '',
