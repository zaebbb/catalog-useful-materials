...
import {
  ...
  patternArticleStoryData, patternBookStoryData, patternCodeStoryData,
  patternCourseStoryData, patternIssueStoryData,
  patternLayoutStoryData, patternServiceStoryData,
