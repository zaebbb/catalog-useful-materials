...
import {
  CategoriesPageContentContainer,
} from '../CategoriesPageContentContainer/CategoriesPageContentContainer'

const CategoriesPage: React.FC = memo(() => {
  ...
  return (
    ...
    >
      <StickyLayout
        ...
        Content={<CategoriesPageContentContainer />}
      />
    </Page>
  )
})
